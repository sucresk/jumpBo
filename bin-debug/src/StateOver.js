...
var StateOver = (function (_super) {
    ...
    StateOver.prototype.onAddToStage = function (event) {
        //设置加载进度界面
        this.removeEventListener(egret.Event.ADDED_TO_STAGE, this.onAddToStage, this);
        this.init();
    };

    StateOver.prototype.init = function () {
    ...
    StateOver.prototype.tapHandler = function (e) {
        this.dispatchEvent(new egret.Event("GameStart"));
    };
    StateOver.prototype.getText = function () {
        var rank = 68.9;
    ...
    StateOver.prototype.getTitle = function () {
...
StateOver.prototype.__class__ = "StateOver";
